...
function iceCreamShop(flavors, favorite) {
  // Base case: if the array of the flavors is empty, return false
  if (flavors.length === 0) {
    return false;
  }

  // Check if the first flavor in the array is the favorite flavor
  if (flavors[0] === favorite) {
    return true;
  }

  // Recursive case: check the rest of the flavors :)
